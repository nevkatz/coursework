...
int main(int argc, char** argv) {
    ...
    //    while (n_connection_threads >= MAX_THREADS || n_requests > 0 || connection_down == 1 || pa.index - pong_sent > 1 )
          if (n_connection_threads >= MAX_THREADS || n_requests > 0 || connection_down == 1 || pa.index - pong_sent > 1)
